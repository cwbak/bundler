...
import {
    ...
    SimpleAccountFactory__factory, UserOperationStruct
 ...
 */
export interface XXXSimpleAccountApiParams extends BaseApiParams {
    owner: Signer
 ...
 */
export class XXXSimpleAccountAPI extends BaseAccountAPI {
    factoryAddress?: string
    owner: Signer
    index: BigNumberish
    ...
    constructor(params: XXXSimpleAccountApiParams) {
        super(params)
    ...
    async createSignedUserOp(info: TransactionDetailsForUserOp): Promise<UserOperationStruct> {
        ...
        userOp.paymasterAndData = (await this.paymasterAPI?.getPaymasterAndData(userOp)) as string
